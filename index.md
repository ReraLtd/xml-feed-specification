...
hero:
  name: "RERA XML"
  text: "Feed Specification"
  tagline: "Unified real estate feed: residential and commercial, sale and rent"
  actions:
    - theme: "brand"
    ...
    - theme: "alt"
      ...
      link: "/examples"
    # - theme: alt
    #   text: Validation feed
    #   link: /validation-feed

features:
  - icon:
      src: home.svg
    title: "Full coverage of property types"
    details: "Residential and commercial listings in one feed. Supports sale and rent."
  - icon:
      src: plan.svg
    title: "Rich attribute set"
    details: "Extensive parameters for layout, zoning, parking, and more. Rules differ for residential and commercial."
  - icon:
      src: lang.svg
    title: "Multilingual and auto-translation"
    details: "Automatic translation of titles and descriptions. English, Greek, and Russian are supported."
  - icon:
      src: magic.svg
    title: "Smart attribute enrichment"
    details: "Automatic inference of attributes from text and photos. Keyword and image analysis fills gaps."
---
...
**Ready to integrate?** Our [comprehensive documentation](/import-specification) and [practical examples](/examples) will get you up and running in hours, not weeks.
